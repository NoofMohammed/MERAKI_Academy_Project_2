let obj = {
  ...
  evening: {
    ...
    قل أعوذ برب ٱلفلق، من شر ما خلق، ومن شر غاسق إذا وقب، ومن شر ٱلنفٰثٰت فى ٱلعقد، ومن شر حاسد إذا حسد.(3 مرات) `,
      ...
      `أمسينا وامسى المـلك لله رب العـالمـين ، اللهـم إنـي أسـألـك خـير هـذا الليله ، فتحها ، ونصرها ، ونـورها وبـركتـها ، وهـداها ، وأعـوذ بـك مـن شـر ما فـيها وشـر ما بعـدها. `,
...
const createButtons = (type) => {
  ...
  const iconLeft =
    $(`<div class='clickLeft'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
  ...
  const iconRight =
    $(`<div class='clickRight'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-square-fill" viewBox="0 0 16 16">
