...
const showThiker = () => {
  for (let i = 0; i < arrayTheker.length; i++) {
    array = obj[arrayTheker[i]].list;
  }
  console.log('-------------+++++')
